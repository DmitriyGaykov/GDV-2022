...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = // таблица ошибок
	{
		...
		ERROR_ENTRY(609, "Использована необъявленая переменная"),
		...
		ERROR_ENTRY(621, "Использован неверные управляющий символ"),
		ERROR_ENTRY_NODEF(622),
		ERROR_ENTRY_NODEF(623),
		ERROR_ENTRY_NODEF(624),
		ERROR_ENTRY_NODEF(625),
		ERROR_ENTRY_NODEF(626),
		ERROR_ENTRY_NODEF(627),
		ERROR_ENTRY_NODEF(628),
		ERROR_ENTRY_NODEF(629),
